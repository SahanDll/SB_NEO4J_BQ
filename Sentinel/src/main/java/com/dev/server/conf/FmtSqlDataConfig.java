...
@EnableJpaRepositories(basePackages = {"com.dev.db.sql.fmt"}, entityManagerFactoryRef = "fmtEntityManagerFactory",
        transactionManagerRef = "fmtTransactionManager")
@EntityScan({ "com.dev.db.sql.fmt", "BOOT-INF.classes.com.dev.db.sql.fmt" })
@ComponentScan("com.dev.db.sql.fmt")
public class FmtSqlDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean fmtEntityManagerFactory() {
        ...
        em.setPackagesToScan("com.dev.db.sql.fmt.bean");
        return em;
    }
