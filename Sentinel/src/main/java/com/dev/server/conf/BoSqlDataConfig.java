...
@EnableJpaRepositories(basePackages = "com.dev.db.sql.bo", entityManagerFactoryRef = "boEntityManagerFactory",
        transactionManagerRef = "boTransactionManager")
@EntityScan({ "com.dev.db.sql.bo", "BOOT-INF.classes.com.dev.db.sql.bo" })
@ComponentScan("com.dev.db.sql.bo")
public class BoSqlDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean boEntityManagerFactory() {
        ...
        em.setPackagesToScan("com.dev.db.sql.bo.bean");
        return em;
    }
