 ...
 */
public class AndroidQueryFactory {
    private static AndroidQueryFactory self;

    private AndroidQueryFactory(){

    }

    public static AndroidQueryFactory getInstance() throws IOException {
        if (self == null) {
            self = new AndroidQueryFactory();
        }
